...
const ApartmentComparisonWidgets = ({ data = {} }) => {
  const LOVELY_COLOR = "#818cf8";    // Softer indigo
  const RELAXING_COLOR = "#f472b6";  // Softer pink
  ...
  const processData = () => {
    ...
    // Process data for each apartment
  ...
  const apartmentData = useMemo(() => processData(), [data]);
